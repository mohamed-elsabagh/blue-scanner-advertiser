...
#define	SPECIAL_CAHARACTER		';'
/* This is special character that indicates end of data portion when more
/  than interface are trying to communicate with each others. */
